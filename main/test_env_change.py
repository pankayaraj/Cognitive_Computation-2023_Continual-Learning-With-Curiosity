...
parser.add_argument("--save_directory", type=str, default="models/native_SAC/diff_mass")
...
torch.save(results, "native_SAC/results/results_mass__s_i_" + str(args.save_interval) )
