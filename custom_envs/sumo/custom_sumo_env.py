...
#from scipy.misc import imread   #decrepted
...
class SUMOEnv(Env):
    ...
    def __init__(self, mode='gui', port_no= 8870, simulation_end=3600):
    ...
    def initSimulator(self, withGUI, portnum):
        ...
        sumoConfig = "sumo_configs/0002.sumocfg"
    ...
    def addEgoCar(self):
        ...
        self.traci.vehicle.addFull(self.egoCarID, 'routeEgo', depart=None, departPos='84.0', departSpeed='0',
