...
rew_hrf_total = [[] for j in range(int(no_steps/length_interval))]
rew_hrf_ind_avg = []
...
rew_fifo_total = [[] for j in range(int(no_steps/length_interval))]
rew_fifo_ind_avg = []
...
rew_res_total = [[] for j in range(int(no_steps/length_interval))]
rew_res_ind_avg = []
...
rew_res_cur_total = [[] for j in range(int(no_steps/length_interval))]
rew_res_cur_ind_avg = []
...
rew_res_cur_std = np.std(rew_res_total, axis=1)
