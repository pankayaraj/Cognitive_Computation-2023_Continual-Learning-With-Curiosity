...
class Half_Reservoir_w_Curn_Time_Restriction_FIFO_Replay_Buffer():
    ...
    def push(self, state, action, action_mean, reward, curiosity, next_state, done_mask):
        ...
        if ran < self.fifo_frac:
            ...
            p = self.reservior_buffer.push(state, action, action_mean, reward, curiosity, next_state, done_mask, self.t)
