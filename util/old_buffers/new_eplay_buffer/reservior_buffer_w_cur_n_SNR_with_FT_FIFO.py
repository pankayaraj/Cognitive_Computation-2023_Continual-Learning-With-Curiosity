...
class Half_Reservoir_Cur_n_SNR_FIFO_Flow_Through_Replay_Buffer():
    ...
    def __init__(self, capacity=10000, fifo_fac = 0.5, avg_len_snr=250, measre_reset_after_threshold=20000,
        ...
        self.reservior_buffer = Reservoir_with_Cur_SNR_Replay_Memory(capacity=self.reservior_capacity,
                                                                     avg_len_snr=avg_len_snr, measre_reset_after_threshold=measre_reset_after_threshold,
                                                                     measure_decrement=measure_decrement, snr_factor=snr_factor,
                                                                     )
        self.t = 0
