...
from util.new_replay_buffers.reservoir_task_seperation import Reservoir_Task_Seperation_Replay_Memory
import random
...
class Half_Reservoir_Flow_Through_w_Cur():
    ...
    def __init__(self, capacity=10000, fifo_fac = 0.5, avg_len_snr=400, repetition_threshold=28000, snr_factor=5.5):
        ...
        self.reservior_buffer = Reservoir_Task_Seperation_Replay_Memory(capacity=self.reservior_capacity,
