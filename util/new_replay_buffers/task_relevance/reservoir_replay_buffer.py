...
class Reservoir_Replay_Memory_TR():
    ...
    def push(self, state, action, action_mean, reward, next_state, done_mask, tie_breaker, initial_state, time_step, ):
    ...
    def sample(self, batch_size):
        ...
        state, action, action_mean, reward, next_state, done_mask, initial_state, time_step =  self.encode_sample(indices=indices)
