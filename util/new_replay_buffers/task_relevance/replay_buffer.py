...
class Transition_tuple():
    ...
    def __init__(self, state, action, action_mean, reward, next_state, done_mask, initial_state, time_step):
    ...
    def get_all_attributes(self):
        return [self.state, self.action,  self.action_mean, self.reward, self.next_state, self.done_mask, self.initial_state, self.time_step]

class Replay_Memory_TR():
    ...
    def push(self, state, action, action_mean, reward, next_state, done_mask, initial_state, time_step):
        data = (state, action, action_mean, reward, next_state, done_mask, initial_state, time_step)
    ...
    def sample(self, batch_size):
        ...
        state, action, action_mean, reward, next_state, done_mask, initial_state, time_step = self.encode_sample(indices)

        return Transition_tuple(state, action, action_mean, reward, next_state, done_mask, initial_state, time_step)
