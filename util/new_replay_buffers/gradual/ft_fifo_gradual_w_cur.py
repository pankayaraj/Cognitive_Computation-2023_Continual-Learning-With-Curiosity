...
from util.new_replay_buffers.gradual.fifo_gradual_buffer import FIFO_Replay_Memory_Gradual
import random
...
class FIFO_w_Cur_Gradual():
    ...
    def __init__(self, capacity=10000, curisoity_buff_frac = 0.34, seperate_cur_buffer=True,
                 ...
                 #fifo_fac = 0.05, avg_len_snr=600, repetition_threshold=30000, snr_factor=1.5):
        ...
        self.reservior_buffer = FIFO_Replay_Memory_Gradual(capacity=self.reservior_capacity,
